...
if(isset($_POST['submit'])){
	...
	$query3 = "SELECT * FROM Students WHERE MIS = '$mis' and Hostel_id = '$hostel_id' and Room_id = '$room_id'";
    ...
    if($result3){
    	$query4 = "UPDATE Student SET Hostel_id = NULL, Room_id = NULL WHERE MIS = '$mis'";
    	$result4 = mysqli_query($conn,$query4);
    	if($result4){
    		$query5 = "UPDATE Room SET Allocated = '0' WHERE Room_id = '$room_id'";
    		$result5 = mysqli_query($conn,$query5);
    		if($result5){
    			$query6 = "DELETE FROM Application WHERE MIS = '$mis'";
	...
	<div class="container py-md-5">
		...
		<div class="footer-grid">
			...
			<div class="agileits_w3layouts-copyright mt-4 text-center">
				<p>© 2024. All Rights Reserved | Design by Anuj and Vishal</p>
		</div>
		</div>
	</div>
</footer>
