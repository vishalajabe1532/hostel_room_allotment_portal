				...
				<form action="contact.php" method="post">
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="rol_no" placeholder="Roll Number" value="<?php echo $_SESSION['mis']; ?>" required="">
							</div>
							<div class="contact-fields-w3ls">
...
if(isset($_POST['submit'])){
	...
	$query = "INSERT INTO Message (sender_id,receiver_id,hostel_id,subject_h,message,msg_date,msg_time) VALUES ('$mis','$hos_man_id','$hostel_id','$subject','$message','$today_date','$time')";
