				...
				<form action="application_form.php?id=<?php echo $_GET['id']?>" method="post">
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="roll_no" placeholder="Roll Number" value="<?php echo $_SESSION['mis']?>" required="" disabled="disabled">
							</div>
							<div class="contact-fields-w3ls">
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="http://COEP.ac.in" target="_blank">COEP </a>
		</div>
...
<?php
   ...
   if(isset($_POST['submit'])){
     ...
     $query_imp2 = "SELECT * FROM Application WHERE MIS = '$mis'";
     $result_imp2 = mysqli_query($conn,$query_imp2);
     if(mysqli_num_rows($result_imp2)==0){


     $query = "SELECT * FROM Students WHERE MIS = '$mis'";
     ...
     if($row = mysqli_fetch_assoc($result)){
        ...
        if($pwdCheck == false){
            ...
            $query3 = "INSERT INTO Application (MIS,Hostel_id,Application_status,Message) VALUES ('$mis','$hostel_id',true,'$message')";
