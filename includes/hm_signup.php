...
if (isset($_POST['hm_signup_submit'])) {
  ...
  if(!preg_match("/^[a-zA-Z0-9]*$/",$username)){
    ...
    if(!mysqli_stmt_prepare($stmt, $sql)){
      ...
      //  $sql = "INSERT INTO Hostel_Manager (MIS, Fname, Lname, Mob, Branch, Year_of_study, Pwd) VALUES (?, ?, ?, ?, ?, ?, ?)";
        //$sql = "INSERT INTO Hostel_Manager (Username, Fname, Lname, Mob, Hostel_id, Email, Pwd, Isadmin) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        //$stmt = mysqli_stmt_init($conn);
          ...
          if($row = mysqli_fetch_assoc($result)){
            ...
            $zz = 0;
            $sql = "INSERT INTO Hostel_Manager (Username, Fname, Lname, Mob, Hostel_id, Email, Pwd, Isadmin) VALUES ('$username', '$fname', '$lname', '$mobile', '$HostelID', '$email', '$hashedPwd', '$zz')";
