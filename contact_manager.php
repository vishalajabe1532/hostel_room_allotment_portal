				...
				<form action="contact_manager.php" method="post">
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="student_mis_no" placeholder="Student Roll Number" required="">
							</div>
							<div class="contact-fields-w3ls">
...
if(isset($_POST['submit'])){
	...
	$query = "INSERT INTO Message (sender_id,receiver_id,hostel_id,subject_h,message,msg_date,msg_time) VALUES ('$man_id','$mis','$hostel_id','$subject','$message','$today_date','$time')";
