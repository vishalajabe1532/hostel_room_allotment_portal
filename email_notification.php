...
try {
    //Server settings
    $mail->isSMTP();
    $mail->Host       = 'https://outlook.office365.com/mail/'; // Your SMTP server host
    $mail->SMTPAuth   = true;
    ...
    $mail->addAddress('abhangap21.comp@coeptech.ac.in', 'Abhang Anuj Pravin'); // Recipient's email and name
