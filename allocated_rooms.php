...
<form id="notify_form" action="includes/inform_room_allocation.inc.php" method="POST">
	<input type="submit" class="btn btn-primary" value="Notify Students about Room Allotment" name="notify_room_allotment">
</form>
